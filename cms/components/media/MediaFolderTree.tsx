...
import { getTreeIndentClass } from '../../utils/dynamic-styles';
...
function FolderNode({ 
  ...
  return (
    <div>
      <div
        className={`flex items-center py-1 px-2 rounded cursor-pointer hover:bg-gray-100 ${getTreeIndentClass(level)} ${
